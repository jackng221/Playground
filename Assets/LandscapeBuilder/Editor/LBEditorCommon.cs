...
namespace LandscapeBuilder
{
    ...
    public class LBEditorCommon
    {
        ...
        public static string LBVersion { get { return "2.4.7"; } }
        ...
        )
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    lbTemplate.detailScatterModeInt = landscape.GetLandscapeDetailScatterMode();
                    ...
                    lbTemplate.isGroupScalePrefabByOriginal = landscape.isGroupScalePrefabByOriginal;
                    lbTemplate.maxGroupNoPrefabTime = landscape.maxGroupNoPrefabTime;
                    ...
                    lbTemplate.isUndoTexturesDisabled = landscape.isUndoTexturesDisabled;
                    lbTemplate.isUndoGrassDisabled = landscape.isUndoGrassDisabled;
                    lbTemplate.isUndoTreesDisabled = landscape.isUndoTreesDisabled;
