...
namespace LandscapeBuilder
{
    ...
    public class LBTemplateEditor : Editor
    {
        ...
        private SerializedProperty detailResolutionProp;
        ...
        private SerializedProperty useVegetationSystemProp;
        ...
        public void OnEnable()
        {
            ...
            detailResolutionProp = serializedObject.FindProperty("detailResolution");
            ...
            // Vegetation Studio or Vegetation Studio Prop
            useVegetationSystemProp = serializedObject.FindProperty("useVegetationSystem");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            labelText = "<color=" + txtColourName + "><b>Grass (Detail) Resolution</b></color>";
            EditorGUILayout.LabelField(labelText, labelFieldRichText, GUILayout.Width(EditorGUIUtility.labelWidth));
            labelText = "<color=" + txtColourName + ">" + detailResolutionProp.intValue + "</color>";
            EditorGUILayout.LabelField(labelText, labelFieldRichText);
            EditorGUILayout.EndHorizontal();
            ...
            EditorGUILayout.BeginHorizontal();
            labelText = "<color=" + txtColourName + "><b>VS or VS Pro in use</b></color>";
            EditorGUILayout.LabelField(labelText, labelFieldRichText, GUILayout.Width(EditorGUIUtility.labelWidth));
            labelText = "<color=" + txtColourName + ">" + useVegetationSystemProp.boolValue + "</color>";
            EditorGUILayout.LabelField(labelText, labelFieldRichText);
            EditorGUILayout.EndHorizontal();
            ...
            if (GUILayout.Button("Create New " + (isPopulateLandscapeProp.boolValue ? "" : "unpopulated ") + "Landscape from Template"))
            {
                ...
                else
                {
                    ...
                    if (lbLandscape != null)
                    {
                        ...
                        // Prevent editor errors about layout
                        GUIUtility.ExitGUI();
                    }
                }
            }
            ...
            {
                serializedObject.Update();
                EditorGUILayout.PropertyField(sizeProp, new GUIContent("Landscape Size"));
                serializedObject.ApplyModifiedProperties();
