...
namespace LandscapeBuilder
{
    ...
    public class LBTerrainHighlight : MonoBehaviour
    {
        ...
        /// <summary>
        /// Attempt to find the first LBTerrainHightlight in the scene
        /// </summary>
        /// <returns></returns>
        public static LBTerrainHighlight FindFirstHighlight()
        {
            #if UNITY_2022_2_OR_NEWER
            return GameObject.FindFirstObjectByType<LBTerrainHighlight>();
            #else
            return GameObject.FindObjectOfType<LBTerrainHighlight>();
            #endif
        }
