...
namespace LandscapeBuilder
{
    public class LBScreenShot : MonoBehaviour
    {
        ...
        /// <summary>
        /// Attempt to find the first LBScreenShot in the scene
        /// </summary>
        /// <returns></returns>
        public static LBScreenShot FindFirstHighlight()
        {
            #if UNITY_2022_2_OR_NEWER
            return GameObject.FindFirstObjectByType<LBScreenShot>();
            #else
            return GameObject.FindObjectOfType<LBScreenShot>();
            #endif
        }
