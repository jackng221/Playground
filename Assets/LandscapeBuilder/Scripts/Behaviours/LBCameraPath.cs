...
namespace LandscapeBuilder
{
    ...
    public class LBCameraPath : MonoBehaviour
    {
        ...
        public static List<LBCameraPath> GetCameraPathsInScene()
        {
            ...
            return new List<LBCameraPath>(GameObject.FindObjectsByType<LBCameraPath>(FindObjectsSortMode.None));
            #else
    ...
    public class LBCameraPathInspector : Editor
    {
        ...
        private readonly static GUIContent reversePointsButtonContent = new GUIContent("<->", "Reverse the direction of the path points");
        #endregion
        ...
        public override void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                if (GUILayout.Button(reversePointsButtonContent, GUILayout.MaxWidth(40f)))
                {
                    GUI.FocusControl(null);
                    if (cameraPathScript.lbPath.positionList.Count > 0)
                    {
                        cameraPathScript.lbPath.positionList.Reverse();
                ...
                if (GUILayout.Button("+", GUILayout.MaxWidth(30f)))
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            LBLandscape landscape = LBLandscape.FindFirstLandscape();
