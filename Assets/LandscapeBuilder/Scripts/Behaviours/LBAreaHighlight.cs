...
namespace LandscapeBuilder
{
    ...
    public class LBAreaHighlight : MonoBehaviour
    {
        ...
        /// <summary>
        /// Attempt to find the first LBAreaHighlight in the scene
        /// </summary>
        /// <returns></returns>
        public static LBAreaHighlight FindFirstHighlight()
        {
            #if UNITY_2022_2_OR_NEWER
            return GameObject.FindFirstObjectByType<LBAreaHighlight>();
            #else
            return GameObject.FindObjectOfType<LBAreaHighlight>();
            #endif
        }
