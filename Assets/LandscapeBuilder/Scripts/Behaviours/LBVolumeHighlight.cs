...
namespace LandscapeBuilder
{
    ...
    public class LBVolumeHighlight : MonoBehaviour
    {
        ...
        /// <summary>
        /// Attempt to find the first LBVolumeHighlight in the scene
        /// </summary>
        /// <returns></returns>
        public static LBVolumeHighlight FindFirstHighlight()
        {
            #if UNITY_2022_2_OR_NEWER
            return GameObject.FindFirstObjectByType<LBVolumeHighlight>();
            #else
            return GameObject.FindObjectOfType<LBVolumeHighlight>();
            #endif
        }
