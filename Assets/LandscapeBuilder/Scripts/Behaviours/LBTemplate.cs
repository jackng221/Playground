...
namespace LandscapeBuilder
{
    ...
    public class LBTemplate : MonoBehaviour
    {
        ...
        [HideInInspector] public int detailScatterModeInt = 1; // New in U2022.2 as detailScatterMode
        ...
        [HideInInspector] public bool useUnityDistanceFog;
        [HideInInspector] public bool useExternalFog;
        ...
        [HideInInspector] public float maxGroupNoPrefabTime = 30f;
        ...
        public LBLandscape CreateLandscapeFromTemplate(string landscapeName)
        {
            ...
            for (float xF = 0f; xF < landscapeSize.x; xF += terrainWidth)
            {
                for (float yF = 0f; yF < landscapeSize.y; yF += terrainWidth)
                {
                    ...
                    newTerrain.terrainData.SetDetailScatterMode((DetailScatterMode)detailScatterModeInt);
                    #endif
                    ...
                    if (numTerrains > 0)
                    {
                        ...
                        foreach (Terrain terrain in landscape.landscapeTerrains)
                        {
                            if (terrain != null)
                            {
                                ...
                                #if UNITY_2022_2_OR_NEWER
                                terrain.terrainData.SetDetailScatterMode((DetailScatterMode)detailScatterModeInt);
                                #endif
                                ...
                                terrain.drawInstanced = Application.isEditor ? useTerrainDrawInstanced : false;
        ...
        public void AddLBLightingSettings(LBLighting lbLighting)
        {
            ...
            useUnityDistanceFog = lbLighting.useUnityDistanceFog;
            useExternalFog = lbLighting.useExternalFog;
        ...
        public void ApplyLBLightingSettings(LBLandscape lbLandscape, ref LBLighting lbLighting, Camera camera, bool resetTimeToStartOfDay)
        {
            ...
            lbLighting.useUnityDistanceFog = useUnityDistanceFog;
            lbLighting.useExternalFog = useExternalFog;
