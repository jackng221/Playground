    ...
    public class LBIntegration : MonoBehaviour
    {
        ...
        public static void GetERRoadList(List<LBRoad> roadList, bool showErrors)
        {
            ...
            else
            {
                ...
                {                 
                    // GetRoads() became obsolete in ER3.2 and was replaced with GetRoadObjects()
                    EasyRoads3Dv3.ERRoad[] erRoads = eRRoadNetwork.GetRoadObjects();
                    ...
                    for (int r = 0; r < numRoads; r++)
                    {
                        ...
                        if (lbRoad != null && erRoad != null)
                        {
                            ...
                            // GetLength() became obsolete in ER3.1.9f1 and was replaced with GetDistance()
                            lbRoad.roadLength = erRoad.GetDistance();
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        // GetRoads() became obsolete in ER3.2 and was replaced with GetRoadObjects()
                        var erRoads = erRoadNetworkType.InvokeMember("GetRoadObjects", System.Reflection.BindingFlags.InvokeMethod, null, erRoadNetworkObj, new object[] { });
                        if (erRoads != null)
                        {
                            // Loop through the ERRoad[] array
                            for (int r = 0; r < ((object[])erRoads).Length; r++)
                            {
                                ...
                                if (erRoad != null)
                                {
                                    ...
                                    if (lbRoad != null)
                                    {
                                        ...
                                        // GetLength() became obsolete in ER3.1.9f1 and was replaced with GetDistance()
                                        lbRoad.roadLength = (float)erRoadType.InvokeMember("GetDistance", System.Reflection.BindingFlags.InvokeMethod, null, erRoad, new object[] { });
        ...
        public static bool VegetationStudioEnable(LBLandscape landscape, bool isEnabled, bool showErrors)
        {
            ...
            else if (landscape.landscapeTerrains == null) { if (showErrors) { Debug.LogWarning("ERROR: " + methodName + " - landscape.landscapeTerrains cannot be null"); } }
            {
                ...
                if (isEnabled)
                {
                    ...
                    AwesomeTechnologies.VegetationStudio.VegetationStudioManager vegetationStudioManager = GameObject.FindFirstObjectByType<AwesomeTechnologies.VegetationStudio.VegetationStudioManager>();
                    #else
        ...
        public static bool VegetationStudioImportTextures(LBLandscape landscape, bool showErrors)
        {
            ...
            #if UNITY_2022_2_OR_NEWER
            AwesomeTechnologies.VegetationStudio.VegetationStudioManager vegetationStudioManager = FindFirstObjectByType<AwesomeTechnologies.VegetationStudio.VegetationStudioManager>();
            #else
            AwesomeTechnologies.VegetationStudio.VegetationStudioManager vegetationStudioManager = FindObjectOfType<AwesomeTechnologies.VegetationStudio.VegetationStudioManager>();
            #endif
            ...
            else
            {
                ...
                if (isEnabled)
                {
                    try
                    {
                        ...
                        #if UNITY_2022_2_OR_NEWER
                        VegetationStudioManager vegetationStudioManager = FindFirstObjectByType<VegetationStudioManager>();
                        #else
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    bool isExistingVegetationPackage = false;                                    
                                    VegetationPackagePro vegetationPackagePro = null;

                                    // Is there a custom biome being used for this landscape that was created outside LB in VS Pro's editor?
                                    // This is configured on Terrain Settings on the Landscape tab.
                                    if (landscape.useCustomBiome && landscape.lbBiome != null && vsPro.VegetationPackageProList.Count > landscape.lbBiome.biomeIndex)
                                    {
                                        vegetationPackagePro = vsPro.VegetationPackageProList[landscape.lbBiome.biomeIndex];
                                    }
                                    else
                                    {
                                        ...
                                        vegetationPackagePro = GetVegetationPackagePro(landscape, ref isExistingVegetationPackage, showErrors);
                ...
                else
                {
                    #region Remove any Veg Studio scripts from the terrains
                    #if UNITY_2022_2_OR_NEWER
                    AwesomeTechnologies.VegetationSystem.VegetationSystemPro vsPro = FindFirstObjectByType<AwesomeTechnologies.VegetationSystem.VegetationSystemPro>();
                    #else
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (pvstoragePackage != null)
                        {
                            ...
                            if (landscape.useCustomBiome && landscape.lbBiome != null && vsPro.VegetationPackageProList.Count > landscape.lbBiome.biomeIndex)
                            {
                                vegetationPackage = vsPro.VegetationPackageProList[landscape.lbBiome.biomeIndex];
                            }
                            else
                            {
                                vegetationPackage = vsPro.VegetationPackageProList.Find(vp => vp.PackageName.StartsWith("LB " + landscape.name));
                            }
                    ...
                    else
                    {
                        ...
                        if (pvstoragePackage != null)
                        {
                            ...
                            else
                            {
                                ...
                                // Used for imported grass
                                LBRandom lbRandom = null;


                                //bool[] validImportedGrass = new bool[numTerrains];

                                //if (numLBGrass > 0 && numTerrains > 0 && enabledGrassTerrainList.FindIndex(gr => gr.grassPlacingMode == LBTerrainGrass.GrassPlacingMode.Imported) >= 0)
                                //{
                                ...
                                for (int grIdx = 0; grIdx < numLBGrass; grIdx++)
                                {
                                    ...
                                    if (vegetationItemInfoPro != null)
                                    {
                                        ...
                                        {
                                            #region Add Imported Grass to Persistant Storage Package (EDITOR ONLY)

                                            // Enable - cannot use persistent storage data for detail density
                                            vegetationItemInfoPro.EnableRuntimeSpawn = false;

                                            Terrain terrain = null;
                                            TerrainData tData = null;
                                            LBTerrainData lbTerrainData = null;

                                            // Use a flattened 4x4 array to simulate a grass patch with max
                                            // density of 16.
                                            List<int> patchList = new List<int>(16);

                                            if (lbRandom == null) { lbRandom = new LBRandom(); }
                                            ...
                                            for (int tIdx = 0; tIdx < numTerrains; tIdx++)
                                            {
                                                ...
                                                if (terrain != null)
                                                {
                                                    ...
                                                    Vector3 terrainWSPos = terrain.transform.position;

                                                    if (tData != null)
                                                    {
                                                        lbTerrainData = lbTerrainGrass.lbTerrainDataList.Find(td => td.sourceTerrainDataName == tData.name);

                                                        lbRandom.SetSeed((int)(terrainWSPos.x + terrainWSPos.z));

                                                        // Validate LBTerrainData for Grass
                                                        if (lbTerrainData != null && lbTerrainData.ValidateGrassDetailData(landscape, true))
                                                        {
                                                            ...
                                                            float detailPixelWidth = detailWidth / terrainSize.x;
                                                            float detailPixelHeight = detailHeight / terrainSize.z;

                                                            float halfDetailPixelWidth = detailPixelWidth / 2f;
                                                            float halfDetailPixelHeight = detailPixelHeight / 2f;

                                                            float detailPatchCellWidth = detailPixelWidth / 4f;
                                                            float detailPatchCellHeight = detailPixelHeight / 4f;

                                                            int minDetailDensity = lbTerrainGrass.minDensity;
                                                            int maxDetailDensity = lbTerrainGrass.density;

                                                            //Debug.Log("[DEBUG] grass pixel density: " + detailPixelWidth + "x" + detailPixelHeight);

                                                            Vector3 grassWSPos, patchWSPos = Vector3.zero, grassScale = Vector3.one;
                                                            float xPosN, yPosN, height, cellOffsetX, cellOffsetY;
                                                            int detailFactor = 0;
                                                            ...
                                                            for (int y = 0; y < detailHeightInt; y++)
                                                            {
                                                                ...
                                                                {
                                                                    // Detail Density is the number of detail objects within the pixel area of the detail map
                                                                    // This is equivalent to tData.GetDetailLayer(..)
                                                                    // We always need this to make sure we don't place grass when it was previously 0 density
                                                                    detailFactor = lbTerrainData.grassDetailDensityData[y * detailWidthInt + x];

                                                                    if (detailFactor > 0)
                                                                    {
                                                                        if (!lbTerrainGrass.useImportedDensity)
                                                                        {
                                                                            // Use custom range
                                                                            detailFactor = Mathf.RoundToInt(lbRandom.Range(minDetailDensity, maxDetailDensity));
                                                                        }

                                                                        if (detailFactor > 15) { detailFactor = 15; }

                                                                        #region Get position of this grass/detail point
                                                                        // Get "terrain position" of grass detail point - values between 0 and 1
                                                                        xPosN = (float)x / (detailWidth - 1f);
                                                                        yPosN = (float)y / (detailHeight - 1f);
                                                                        ...
                                                                        patchWSPos.x = (yPosN * terrainSize.x) + terrainWSPos.x;
                                                                        patchWSPos.z = (xPosN * terrainSize.z) + terrainWSPos.z;
                                                                        #endregion

                                                                        #region Place the number of detail grass objects

                                                                        /// TODO - need a patch or cell-based placement system and a fast way to determine if it is occupied
                                                                        /// 4x4 grid would give max 16 density
                                                                        patchList.Clear();

                                                                        int maxLoops = 100;
                                                                        int dObjIdx = 0;
                                                                        for (int loopIdx = 0; dObjIdx < detailFactor && loopIdx < maxLoops; loopIdx++)
                                                                        {
                                                                            int cellIdx = lbRandom.Range(0, 15);

                                                                            // Check if this grass cell has already been used
                                                                            if (patchList.FindIndex(ce => ce == cellIdx) < 0)
                                                                            {
                                                                                patchList.Add(cellIdx);
                                                                                dObjIdx++;

                                                                                int cellY = (int)(cellIdx / 4);
                                                                                int cellX = cellIdx < 4 ? cellIdx : cellIdx - (cellY * 4);

                                                                                // Get the pixel position relative to the centre of the patch
                                                                                cellOffsetX = cellX * detailPatchCellWidth - halfDetailPixelWidth;
                                                                                cellOffsetY = cellY * detailPatchCellHeight - halfDetailPixelHeight;

                                                                                // TODO - get the normalised offset height
                                                                                // Interpolate between grass based on height
                                                                                height = tData.GetInterpolatedHeight(yPosN + (cellOffsetY / terrainSize.z), xPosN + (cellOffsetX / terrainSize.x));

                                                                                grassWSPos.x = patchWSPos.x + cellOffsetX;
                                                                                grassWSPos.y = height;
                                                                                grassWSPos.z = patchWSPos.z + cellOffsetY;

                                                                                grassScale.x = lbRandom.Range(lbTerrainGrass.minWidth, lbTerrainGrass.maxWidth);
                                                                                grassScale.z = grassScale.x;
                                                                                grassScale.y = lbRandom.Range(lbTerrainGrass.minHeight, lbTerrainGrass.maxHeight);

                                                                                persistentVegetationStorage.AddVegetationItemInstance
                                                                                    (lbTerrainGrass.GUID, grassWSPos, grassScale,
                                                                                      Quaternion.Euler(0, lbRandom.Range(-359.9f, 360f), 0), true, vegetationSourceID, 1.0f
                                                                                    );
                                                                            }
                                                                        }
        ...
        public static bool isRTPInstalled(bool showErrors)
        {
            ...
            catch
            {
                if (showErrors)
                {
                    Debug.LogWarning("LBIntegration.isRTPInstalled: it appears that Relief Terrain Pack 3.3q or newer is not installed in this project.");
                }
            }
        ...
        /// Currently support RTP v3.3n
        /// In 2019.4 and RTP v3.3q for some unknown reason we need to use methodInfo.Invoke rather than
        /// objectType.InvokeMember for CombineNormals(..).
        /// </summary>
        /// <param name="landscape"></param>
        ...
        /// <returns></returns>
        public static bool RTPEnable(LBLandscape landscape, Terrain terrain, bool isEnabled, bool isFirstTerrain, bool isLastTerrain, bool showErrors, bool isRetry = false)
        {
            bool isSuccessful = false;
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (rtpReliefTerrainType != null && rtpGlobalSettingsHolderType != null && rtpLODmanagerType != null)
                    {
                        ...
                        if ((rtpReliefTerrain == null || isRetry) && isEnabled)
                        {
                            bool isAdding = rtpReliefTerrain == null;

                            var rtpReliefTerrainAdded = isAdding ? terrain.gameObject.AddComponent(rtpReliefTerrainType) : rtpReliefTerrain;

                            if (isAdding)
                            {
                                // Try to add the default shader
                                Shader rtpShader = Shader.Find("Relief Pack/ReliefTerrain-FirstPass");
                                if (terrain.materialTemplate != null && rtpShader != null && !terrain.materialTemplate.shader.name.Contains("Relief Pack"))
                                {
                                    terrain.materialTemplate.shader = rtpShader;
                                }

                                //Debug.Log("[DEBUG]  terrain.materialTemplate " + terrain.materialTemplate.shader.name + " shader: " + rtpShader.name);
                            }
                            ...
                            if (isLastTerrain)
                            {
                                ...
                                if (rtpReliefTerrainAdded != null)
                                {
                                    ...
                                    #if UNITY_2022_2_OR_NEWER
                                    var rtpLODmanager = GameObject.FindFirstObjectByType(rtpLODmanagerType);
                                    #else
                                    ...
                                    else
                                    {
                                        ...
                                        // Avoid issue where far distance just shows the global colour map - which by default is white
                                        rtpLODmanagerType.InvokeMember("RTP_SIMPLE_FAR_FIRST", System.Reflection.BindingFlags.SetField, null, rtpLODmanager, new object[] { false });
                                    }
                                        ...
                                        if (Bumps != null && Heights != null)
                                        {
                                            if (terrainTexturesListNoDisabled != null)
                                            {
                                                ...
                                                if (numTextures > 0)
                                                {
                                                    ...
                                                    var combineNormalsMethod = ReflectionGetMethod(rtpGlobalSettingsHolderType, "CombineNormals", true, false);
                                                    //Debug.Log("[DEBUG] combineNormalsMethod " + combineNormalsMethod == null ? "Method not found" : combineNormalsMethod.Name + " terrain: " + terrain.name);
                                                    ...
                                                    for (int nm = 0; nm < numTextures; nm++)
                                                    {
                                                        ...
                                                        if (nm % 2 == 1)
                                                        {
                                                            ...
                                                            if (Bumps[nm - 1] != null || Bumps[nm] != null)
                                                            {
                                                                ...
                                                                Texture2D combinedBump = (Texture2D)combineNormalsMethod.Invoke(globalSettingsHolder, new object[] { texture1, texture2 });
                                                        ...
                                                        else if (nm == numTextures - 1 && Bumps[nm] != null)
                                                        {
                                                            ...
                                                            Texture2D combinedBump = (Texture2D)combineNormalsMethod.Invoke(globalSettingsHolder, new object[] { Bumps[nm], greyTexture2D });
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                        ...
                                        for (int nm = 0; nm < numLBTextures; nm++)
                                        {
                                            ...
                                            if (nm % 2 == 1)
                                            {
                                                ...
                                                if (Bumps[nm - 1] != null || Bumps[nm] != null)
                                                {
                                                    ...
                                                    Texture2D combinedBump = (Texture2D)combineNormalsMethod.Invoke(globalSettingsHolder, new object[] { texture1, texture2 });
                                                    //Debug.Log("[DEBUG] combinedBump: " + combinedBump.texelSize);
                                    ...
                                    // Turn RTP terrain property synch back on 
                                    RTPSetSync(true, true);
                                }
                            }
                        }
                    }
        ...
        /// <summary>
        /// Attempt to find the RTP LOD Manager in the scene and turn on or off property synch between RTP scripts on multiple terrains
        /// </summary>
        /// <param name="enableSync"></param>
        /// <param name="showErrors"></param>
        public static void RTPSetSync(bool enableSync, bool showErrors)
        {
            System.Type rtpLODmanagerType = null;
            ...
            try
            {
                ...
                if (rtpLODmanagerType != null)
                {
                    // After adding at least one Relief Terrain script to a terrain, the LODmanager should be in the scene
                    #if UNITY_2022_2_OR_NEWER
                    var rtpLODmanager = GameObject.FindFirstObjectByType(rtpLODmanagerType);
                    #else
                    var rtpLODmanager = GameObject.FindObjectOfType(rtpLODmanagerType);
                    ...
                    if (rtpLODmanager != null)
                    {
                        rtpLODmanagerType.InvokeMember("dont_sync", System.Reflection.BindingFlags.SetField, null, rtpLODmanager, new object[] { !enableSync });
                    }
                }
            }
            catch (System.Exception ex)
            {
                if (showErrors) { Debug.LogWarning("LBIntegration.RTPSetSync: something went wrong with Relief Terrain Pack Integration. " + ex.Message); }
            }
        }
        ...
        public static bool MicroSplatEnable(LBLandscape landscape, Terrain terrain, Material microSplatMaterial, bool isEnabled, bool isFirstTerrain, bool isLastTerrain, bool showErrors)
        {
            ...
            else if (isEnabled)
            {
                ...
                if (microSplatTerrain == null)
                {
                    ...
                    #if UNITY_2019_2_OR_NEWER
                    else if (microSplatMaterial != null && (microSplatMaterial.shader.name.Contains("MicroSplat") || microSplatMaterial.name.Contains("MicroSplat")))
                    #else
        ...
        /// <summary>
        /// Add MicroSplat components to landscape mesh terrains.
        /// NOTE: Not currently not implemented. Use MicroSplat's own Terrain To Mesh converter.
        /// </summary>
        /// <param name="landscape"></param>
        /// <param name="meshGameObject"></param>
        /// <param name="isEnabled"></param>
        /// <param name="showErrors"></param>
        /// <returns></returns>
        public static bool MicroSplatEnable(LBLandscape landscape, GameObject meshGameObject, bool isEnabled, bool showErrors)
        {
            bool isSuccessful = false;
            string methodName = "LBIntegration.MicroSplatEnable (mesh)";

            // Basic validation
            if (landscape == null) { if (showErrors) { Debug.LogWarning("ERROR: " + methodName + " - landscape cannot be null"); } }
            else if (meshGameObject == null) { if (showErrors) { Debug.LogWarning("ERROR: " + methodName + " - mesh gameobject cannot be null"); } }
            else if (!IsMicroSplatInstalled()) { if (showErrors) { Debug.LogWarning("ERROR: " + methodName + " - MicroSplat 3.5 or newer does not seem to be installed in the project."); } }
            else if (isEnabled)
            {
                #if __MICROSPLAT__
                //MicroSplatMeshTerrain microMeshTerrain = meshGameObject.GetComponent<MicroSplatMeshTerrain>();

                // Single MicroSplatMeshTerrain on parent, then each mesh renderer is added to the MeshTerrains array.

                // Splatmaps are added to the ControlTextures array.
                #endif
            }
            else
            {
