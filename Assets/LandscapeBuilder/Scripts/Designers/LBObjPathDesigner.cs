                            ...
                            #endif
                            {
                                ...
                                if (EditorGUI.EndChangeCheck())
                                {
                                    ...
                                    if (isCtrlKeyPressed)
                                    {
                                        ...
                                        // #SMS v2.3.5 Permit height change when not snapping to terrain and "Path has Width" is enabled
                                        if (lbObjPath.snapToTerrain || !lbObjPath.useWidth) { lbObjPath.RefreshPathHeights(landscape, isInGroupDesignerMode); }
                                    }
