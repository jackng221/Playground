Scriptable Render Pipeline assets in LB require Unity 2020.3.25f1 or newer.
IMPORTANT: Do not import these packages without URP or HDRP installed, else you will get errors. 

1. Import the entire asset (e.g. Landscape Builder) into a project setup for URP or HDRP.
2. If using HDRP, from package manager, import High Definition Render Pipeline 10.7.0 (U2020.3.25 LTS+), or 12.1.4 (U2021.2.12+)
3. If using URP, from package manager, import Universal Render Pipeline 10.7.0 (U2020.3.25 LTS+)
